...
<head>
  ...
  @stack('styles')
  <link rel="stylesheet" href="{{asset('js/datepicker/jquery-ui-1.12.1.custom/jquery-ui.css')}}">
...
@stack('scripts')
<script src="{{asset('js/datepicker/jquery-ui-1.12.1.custom/jquery-ui.js')}}"></script>
